...
sudo iptables -t nat -C PREROUTING -p tcp --dport 47984:47990 -j DNAT --to-destination ${VM_IP} 2>/dev/null || \
    sudo iptables -t nat -A PREROUTING -p tcp --dport 47984:47990 -j DNAT --to-destination ${VM_IP}
...
sudo iptables -C FORWARD -d ${VM_IP} -p tcp --dport 47984:47990 -j ACCEPT 2>/dev/null || \
    sudo iptables -A FORWARD -d ${VM_IP} -p tcp --dport 47984:47990 -j ACCEPT
...
sudo iptables -C LIBVIRT_FWI -d ${VM_IP} -o virbr0 -p tcp --dport 47984:47990 -j ACCEPT 2>/dev/null || \
    sudo iptables -I LIBVIRT_FWI 1 -d ${VM_IP} -o virbr0 -p tcp --dport 47984:47990 -j ACCEPT
