...
echo "================================================"
echo "  HomeLabHub - Linode Server Bootstrap"
echo "  Step 1: Server Setup (Docker, Tailscale, UFW)"
echo "================================================"
echo ""
...
print_summary() {
    ...
    echo "================================================"
    echo ""
    echo "Server is ready. Now deploy the services:"
    echo ""
    echo "  1. Clone/pull your repo:"
    echo "     git clone https://github.com/yourusername/HomeLabHub.git"
    echo "     cd HomeLabHub"
    echo ""
    ...
    echo "     ./deploy/scripts/bootstrap.sh"
    echo ""
    echo "  5. Verify:"
    echo "     ./homelab status"
    echo ""
    echo "Update Cloudflare DNS to point to this server's IP"
    echo ""
}
