...
def upgrade() -> None:
    ...
    op.create_table('google_service_status',
        ...
        sa.Column('status', sa.Enum('connected', 'disconnected', 'error', 'pending', name='serviceconnectionstatus', create_type=False), nullable=False, server_default='disconnected'),
    ...
    op.create_table('calendar_automations',
        ...
        sa.Column('status', sa.Enum('active', 'inactive', 'error', name='automationstatus', create_type=False), nullable=False, server_default='active'),
    ...
    op.create_table('email_notifications',
        ...
        sa.Column('status', sa.Enum('pending', 'sent', 'failed', name='emailnotificationstatus', create_type=False), nullable=False, server_default='pending'),
    ...
    op.create_table('drive_backups',
        ...
        sa.Column('status', sa.Enum('pending', 'uploading', 'completed', 'failed', name='backupstatus', create_type=False), nullable=False, server_default='pending'),
